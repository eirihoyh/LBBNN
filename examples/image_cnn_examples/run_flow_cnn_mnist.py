"""MNIST digit classification with BayesianNetworkCNNFlow.
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/flow_cnn_mnist")
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(
            f"[Flow-CNN MNIST] Epoch {epoch:03d} | "
    ...
    print(f"[Flow-CNN MNIST] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkCNNFlow", "dataset": "MNIST",
    ...
    print(f"[Flow-CNN MNIST] Results saved to: {RESULTS_DIR.resolve()}")
