"""CIFAR-10 classification with BayesianNetworkCNNLRT (3-channel colour).
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/lrt_cnn_cifar10")
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(
            f"[LRT-CNN CIFAR-10] Epoch {epoch:03d} | "
    ...
    print(f"[LRT-CNN CIFAR-10] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkCNNLRT", "dataset": "CIFAR-10 (RGB)",
    ...
    print(f"[LRT-CNN CIFAR-10] Results saved to: {RESULTS_DIR.resolve()}")
