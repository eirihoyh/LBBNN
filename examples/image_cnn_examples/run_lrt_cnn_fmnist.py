"""Fashion-MNIST classification with BayesianNetworkCNNLRT.
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/lrt_cnn_fmnist")
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(
            f"[LRT-CNN FashionMNIST] Epoch {epoch:03d} | "
    ...
    print(f"[LRT-CNN FashionMNIST] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkCNNLRT", "dataset": "FashionMNIST",
    ...
    print(f"[LRT-CNN FashionMNIST] Results saved to: {RESULTS_DIR.resolve()}")
