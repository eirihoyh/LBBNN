"""Fashion-MNIST classification with BayesianNetworkLRT.

Run from the image_examples/ directory:
    python run_lrt_fmnist.py
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/lrt_fmnist")
...
def main() -> None:
    ...
    print(f"[LRT FMNIST] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkLRT", "dataset": "FashionMNIST",
    ...
    print(f"[LRT FMNIST] Results saved to: {RESULTS_DIR.resolve()}")
