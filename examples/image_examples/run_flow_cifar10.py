"""CIFAR-10 classification with BayesianNetworkFlow (grayscale).
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/flow_cifar10")
...
def main() -> None:
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        print(
            f"[FLOW CIFAR-10] Epoch {epoch:03d} | "
    ...
    print(f"[FLOW CIFAR-10] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkFlow", "dataset": "CIFAR-10 (grayscale)",
    ...
    print(f"[FLOW CIFAR-10] Results saved to: {RESULTS_DIR.resolve()}")
