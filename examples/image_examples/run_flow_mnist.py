"""MNIST digit classification with BayesianNetworkFlow.

Run from the image_examples/ directory:
    python run_flow_mnist.py
...
SEED = 42
DATA_DIR = Path("data")
RESULTS_DIR = Path("results/flow_mnist")
...
def main() -> None:
    ...
    print(f"[FLOW MNIST] Test accuracy: {test_acc:.4f}")
    ...
    save_json(
        {"model_type": "BayesianNetworkFlow", "dataset": "MNIST",
    ...
    print(f"[FLOW MNIST] Results saved to: {RESULTS_DIR.resolve()}")
