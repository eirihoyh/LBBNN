...
def main():
    ...
    weight_list = weight_matrices_numpy(model)
    ...
    print("[LRT] Saved local contribution plot.")
    ...
    print("[LRT] Saved 'what-if' predictions.")
    ...
    print("[LRT] Saved global explanation plot.")
